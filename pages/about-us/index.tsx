            ...
            .map((_, index) => (
              ...
              >
                {logos.map((logo, key) => (
                  <div
                    key={key}
                    className="flex items-center justify-center h-12 w-32 bg-white/10 backdrop-blur-sm rounded-lg px-4 py-2 border border-blue-400/20 shadow-lg hover:scale-105 hover:bg-white/15 hover:border-blue-400/40 transition-all duration-300"
                  >
                    <Image
                      src={logo.url}
                      width={128}
...
export default function About() {
  ...
  return (
    <div className="w-full min-h-screen bg-gradient-to-br from-slate-900 via-blue-950 to-indigo-950 text-white relative overflow-hidden">
      ...
      {/* Mission & Vision */}
      <section className="w-full py-32 px-6 bg-gradient-to-br from-blue-950 via-indigo-950 to-slate-900 text-white relative">
        <FloatingElements />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-12">
              ...
              >
                {/* Strategy Point 1 */}
                <motion.div
                  className="group flex items-start gap-6 p-6 rounded-2xl bg-gradient-to-r from-blue-500/10 to-transparent border border-blue-400/20 backdrop-blur-sm hover:from-blue-500/15 transition-all duration-300"
                  whileHover={{ scale: 1.02, x: 10 }}
                  transition={{ type: "spring", stiffness: 300 }}
                >
                  <motion.div
                    className="flex-shrink-0 p-3 rounded-full bg-blue-500/20 border border-blue-400/30"
                    animate={{
                      rotate: [0, 360],
                    }}
                    transition={{
                  ...
                  >
                    <Star className="text-blue-300" size={32} strokeWidth={2.5} />
                  </motion.div>
                ...
                {/* Strategy Point 2 */}
                <motion.div
                  className="group flex items-start gap-6 p-6 rounded-2xl bg-gradient-to-r from-cyan-500/10 to-transparent border border-cyan-400/20 backdrop-blur-sm hover:from-cyan-500/15 transition-all duration-300"
                  whileHover={{ scale: 1.02, x: 10 }}
                  transition={{ type: "spring", stiffness: 300 }}
                >
                  <motion.div
                    className="flex-shrink-0 p-3 rounded-full bg-cyan-500/20 border border-cyan-400/30"
                    animate={{
                      rotate: [0, 360],
                    }}
                    transition={{
                  ...
                  >
                    <Star className="text-cyan-300" size={32} strokeWidth={2.5} />
                  </motion.div>
                  <div className="flex-1">
      ...
      <section className="w-full bg-gradient-to-br from-slate-900 via-blue-950 to-indigo-950 text-white py-32 px-6 relative">
        ...
        <div className="w-full max-w-6xl mx-auto relative z-10 mb-32">
          <div className="text-center mb-16">
            ...
            <h3 className="text-5xl md:text-6xl font-black font-NeueMontreal mb-8 bg-gradient-to-r from-white to-blue-200 bg-clip-text text-transparent">
              Why PerpeX?
            </h3>
          </div>
